...
$(document).ready(function() {
    ...
    function randoNum(rangeBegin,rangeEnd){
    	return  Math.floor(Math.random() * (rangeEnd - rangeBegin) + rangeBegin);
    }

    function randoComma() {
        return randoNum(0,10) % 2 === 0 ? "," : "";
    }
    ...
    function randoSentence() {
        ...
        var l = randoNum(4,8);
        for (var i = 1; i < l; i++) {
            sentence = i > 2 && i < (l - 2) && l % 2 === 0 ? sentence + " " + randoWord() + randoComma() : sentence + " " + randoWord();
            } 
        return sentence + ".";
    };
